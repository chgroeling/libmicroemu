...
static Result<Instr> NopT1Decoder(const RawInstr& rinstr, TCpuAccessor& cpua) {
  ...
  return Ok(Instr{ InstrNop{iid, flags,} });
}
...
static Result<Instr> DmbT1Decoder(const RawInstr& rinstr, TCpuAccessor& cpua) {
  ...
  return Ok(Instr{ InstrDmb{iid, flags,} });
}
...
static Result<Instr> LslImmediateT1Decoder(const RawInstr& rinstr, TCpuAccessor& cpua) {
  ...
  flags |= TItOps::InITBlock(cpua) == false? static_cast<InstrFlagsSet>(InstrFlags::kSetFlags):0U;
...
static Result<Instr> PopT1Decoder(const RawInstr& rinstr, TCpuAccessor& cpua) {
  ...
  if ((Bm32::ExtractBits1R<15U, 15U>(registers) == 0x1U) && ( TItOps::InITBlock(cpua)) && (! TItOps::LastInITBlock(cpua))) {
      return Err<Instr>(StatusCode::kDecoderUnpredictable);
  }
...
static Result<Instr> LdrImmediateT4Decoder(const RawInstr& rinstr, TCpuAccessor& cpua) {
  ...
  if ((flags & static_cast<InstrFlagsSet>(InstrFlags::kWBack) && n == t) || t == 15U &&  TItOps::InITBlock(cpua) && ! TItOps::LastInITBlock(cpua)) {
    return Err<Instr>(StatusCode::kDecoderUndefined);
  }
        flags |= static_cast<u8>(InstrFlags::k32Bit);
...
static Result<Instr> AndImmediateT1Decoder(const RawInstr& rinstr, TCpuAccessor& cpua) {
  ...
  assert((Bm16::IsolateBit<15U>(rinstr.high)) == 0b0U);
  assert(((Bm16::ExtractBits1R<11U, 8U>(rinstr.high)) != 0b1111U) || ((Bm16::IsolateBit<4U>(rinstr.low)) != 0b1U));
...
static Result<Instr> Splitter16bit_op10111(const RawInstr& rinstr,TCpuAccessor& cpua) {
    ...
    if (Bm16::ExtractBits1R<6U, 3U>(opcode) == 0b1001U) {
      ...
      if ( (Bm16::ExtractBits1R<3U, 0U>(rinstr.low) == 0x0U) && (Bm16::ExtractBits1R<7U, 4U>(rinstr.low) == 0x0U)) {
...
static Result<Instr> Splitter32bit_op11101(const RawInstr& rinstr,TCpuAccessor& cpua) {
    ...
    if (Bm16::ExtractBits1R<10U, 9U>(rinstr.low) == 0b01U) {
    ...
    } else if ((Bm16::ExtractBits1R<10U, 9U>(rinstr.low) == 0b00U) && (Bm16::IsolateBit<6U>(rinstr.low) == 0b0U)) {
    ...
    } else if ((Bm16::ExtractBits1R<10U, 9U>(rinstr.low) == 0b00U) && (Bm16::IsolateBit<6U>(rinstr.low) == 0b1U)) {
      ...
      } else if ((Bm16::ExtractBits1R<1U, 1U>(op1) == 0b1U) && (Bm16::ExtractBits1R<0U, 0U>(op2) == 0b0U)) {
        return StrdImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
      } else if ((Bm16::ExtractBits1R<1U, 1U>(op1) == 0b0U) && (op2 == 0b11U)) {
        return LdrdImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
      } else if ((Bm16::ExtractBits1R<1U, 1U>(op1) == 0b1U) && (Bm16::ExtractBits1R<0U, 0U>(op2) == 0b1U)) {
        return LdrdImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
...
static Result<Instr> Splitter32bit_op11110(const RawInstr& rinstr,TCpuAccessor& cpua) {
    ...
    if ((op1 == 0b10U) && (op == 0b1U)) {
      ...
      } else if ((_op1 == 0b000U || _op1 == 0b010U) && (Bm16::ExtractBits1R<6U, 1U>(_op)==0b011100U)) {
        return MsrT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
      } else if ((_op1 == 0b000U || _op1 == 0b010U) && (Bm16::ExtractBits1R<6U, 1U>(_op)==0b011111U)) {
...
static Result<Instr> Splitter32bit_op11111(const RawInstr& rinstr,TCpuAccessor& cpua) {
    ...
    if ((Bm16::ExtractBits1R<6U, 4U>(op2) == 0b000U) && (Bm16::ExtractBits1R<0U, 0U>(op2) == 0b0U)) {
    ...
    } else if ((Bm16::ExtractBits1R<6U, 5U>(op2) == 0b00U) && (Bm16::ExtractBits1R<2U, 0U>(op2) == 0b001U)) {
       ...
       } else if (_op1 == 0b00U && (Bm16::IsolateBit<5U>(_op2) == 0b1U) && (Bm16::ExtractBits1R<2U, 2U>(_op2) == 0b1U) && _Rn != 0b1111 && _Rt != 0b1111U) {
         return LdrbImmediateT3Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       } else if (_op1 == 0b00U && Bm16::ExtractBits1R<5U, 2U>(_op2) == 0b1100U && _Rn != 0b1111 && _Rt != 0b1111U) {
         return LdrbImmediateT3Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       } else if (_op1 == 0b11U && _Rn != 0b1111 && _Rt != 0b1111U) {
         return LdrsbImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       }
    } else if ((Bm16::ExtractBits1R<6U, 5U>(op2) == 0b00U) && (Bm16::ExtractBits1R<2U, 0U>(op2) == 0b011U)) {
       ...
       } else if (_op1 == 0b00U &&  Bm16::ExtractBits1R<2U, 2U>(_op2) == 0b1U && Bm16::IsolateBit<5U>(_op2) == 0b1U &&_Rn != 0b1111U  && _Rt != 0b1111U) {
         return LdrhImmediateT3Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       } else if (_op1 == 0b00U &&  Bm16::ExtractBits1R<5U, 2U>(_op2) == 0b1100U && _Rn != 0b1111U  && _Rt != 0b1111U) {
         return LdrhImmediateT3Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       } else if (_op1 == 0b10U &&  Bm16::ExtractBits1R<2U, 2U>(_op2) == 0b1U && Bm16::IsolateBit<5U>(_op2) == 0b1U &&_Rn != 0b1111U  && _Rt != 0b1111U) {
         return LdrshImmediateT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       } else if (_op1 == 0b10U &&  Bm16::ExtractBits1R<5U, 2U>(_op2) == 0b1100U && _Rn != 0b1111U  && _Rt != 0b1111U) {
         return LdrshImmediateT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua);
       }
    } else if ((Bm16::ExtractBits1R<6U, 5U>(op2) == 0b00U) && (Bm16::ExtractBits1R<2U, 0U>(op2) == 0b101U)) {
      // ## Load word
      ...
      } else if (_op1 == 0b00U && Bm16::IsolateBit<5U>(_op2) == 0b1U && (Bm16::ExtractBits1R<2U, 2U>(_op2) == 0b1U)&& _Rn != 0b1111U) {
      ...
      } else if ((Bm16::ExtractBits1R<3U, 2U>(_op1) == 0b10U) && (Bm16::ExtractBits1R<3U, 2U>(_op2) == 0b10U)) {
...
const u16 opc =
   ...
   switch(opc) {
    case 0b00000U: { return Splitter16bit_op00000<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00001U: { return LsrImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00010U: { return AsrImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00011U: { return Splitter16bit_op00011<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00100U: { return MovImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00101U: { return CmpImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00110U: { return AddImmediateT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b00111U: { return SubImmediateT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01000U: { return Splitter16bit_op01000<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01001U: { return LdrLiteralT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01010U: { return Splitter16bit_op01010<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01011U: { return Splitter16bit_op01011<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01100U: { return StrImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01101U: { return Splitter16bit_op01101<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01110U: { return StrbImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b01111U: { return LdrbImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10000U: { return StrhImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10001U: { return LdrhImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10010U: { return StrImmediateT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10011U: { return LdrImmediateT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10100U: { return AddPcPlusImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10101U: { return AddSpPlusImmediateT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10110U: { return Splitter16bit_op10110<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b10111U: { return Splitter16bit_op10111<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11000U: { return StmT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11001U: { return LdmT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11010U: { return BT1Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11011U: { return Splitter16bit_op11011<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11100U: { return BT2Decoder<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11101U: { return Splitter32bit_op11101<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11110U: { return Splitter32bit_op11110<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    case 0b11111U: { return Splitter32bit_op11111<TCpuAccessor, TItOps>(rinstr, cpua) ;}
    default: {
        assert(false);
    // should not happen
    break;
