...
public:
  /**
   * @brief Converts an arbitrary value from big endian to little endian representation.
   *
   * @tparam T The type of the value to be converted.
   * @param value The value to be converted from big endian to little endian representation.
...
/**
 * @brief Specialization for converting a u8 value from big endian to little endian representation.
 * @param value The value to be converted from big endian to little endian representation.
 */
...
/**
 * @brief Specialization for converting a u16 value from big endian to little endian representation.
 * @param value The value to be converted from big endian to little endian representation.
 */
...
/**
 * @brief Specialization for converting a u32 value from big endian to little endian representation.
 * @param value The value to be converted from big endian to little endian representation.
 */
...
/**
 * @brief Specialization for converting a u64 value from big endian to little endian representation.
 * @param value The value to be converted from big endian to little endian representation.
 */
...
/**
 * @brief This class contains a function to convert the endianess from little to little endian.
 *
...
public:
  /**
   * @brief Converts an arbitrary value from little endian to little endian representation.
   *
   * For obvious reasons the mentioned conversion does nothing.
   * @tparam T The type of the value to be converted.
   * @param value The value to be converted from little endian to little endian representation.
   * @return T the converted value
   */
  template <typename T> static constexpr inline T Convert(const T &value) = delete;
...
/**
 * @brief Specialization for converting a u8 value from little to little endian representation.
 * @param value The value to be converted from little endian to little endian representation.
 */
...
/**
 * @brief Specialization for converting a u16 value from little to little endian representation.
 * @param value The value to be converted from little endian to little endian representation.
 */
...
/**
 * @brief Specialization for converting a u32 value from little to little endian representation.
 * @param value The value to be converted from little endian to little endian representation.
 */
...
/**
 * @brief Specialization for converting a u64 value from little to little endian representation.
 * @param value The value to be converted from little endian to little endian representation.
 */
